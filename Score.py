...
# def add_score_board():
#     # write the score board to score.txt from all the games
#     score = open("score.txt", "w")
#     score.write("Memory Game - {} attempts, {} seconds\n".format(MemoryGame["attempts"], MemoryGame["time"]))
#     score.write("Guess Game - {} attempts, {} seconds\n".format(GuessGame["attempts"], GuessGame["time"]))
#     score.write("Currency Roulette - {} attempts, {} seconds\n".format(CurrencyRouletteGame["attempts"],
#                                                                        CurrencyRouletteGame["time"]))
#     score.close()
#
#
# def get_score_board():
...
#
#
# # result = pyfiglet.figlet_format("Hall of Fame")
# # print(result)
#
#
# # show the score board with $PAGER
...
#
#
# def add_score(game_name, difficulty):
#     try:
#         # Try to read the current score from the score file
#         with open('score.txt', 'r') as file:
#             current_score = int(file.read().strip())
#     except FileNotFoundError:
#         # If the score file doesn't exist, create it with an initial score of 0
#         current_score = 0
...
#     new_score = score.add_score_csv(game_name, difficulty, username)
#     print(f"New score: {new_score}")
#
#
# ---
